/** Pastel backgrounds for course cards (cycle by index). */
...
export function courseCardColor(index: number) {
  return COURSE_CARD_COLORS[index % COURSE_CARD_COLORS.length];
}
