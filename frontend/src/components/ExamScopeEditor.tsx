...
export default function ExamScopeEditor({
      ...
      {!editable ? (
        ...
        <>
          <ScopeFields
            ...
            onTeacherChange={setScopeTeacher}
            onYearChange={setScopeYear}
            onSemesterChange={setScopeSemester}
            onGroupChange={setScopeGroup}
          />
          {success && (
  ...
  if (embedded) return <Box dir="rtl">{body}</Box>;
